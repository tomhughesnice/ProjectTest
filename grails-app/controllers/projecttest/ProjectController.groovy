...
import projecttest.Project.Phase;
...
class ProjectController {
    ...
    def save(Project projectInstance) {
		...
		if(projectInstance.priority > (Project.count() + 1)) {
			projectInstance.errors.reject('project.priority.invalid',
				['priority', 'class Project', (Project.count() + 1)] as Object[],
				'[Property [{0}] of class [{1}] exceeds range [{2}]]');
			// The following helps with field highlighting in your view
			projectInstance.errors.rejectValue(
				'priority',
				'project.priority.invalid')
		}
